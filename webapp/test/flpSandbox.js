			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rndsrrui5-display": {
								"semanticObject": "rndsrrui5",
								"action": "display",
								"description": "A Fiori application.",
								"title": "Solicitud de Rembolso Rendición",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									"applicationType": "SAPUI5",
									"additionalInformation": "SAPUI5.Component=rnd.srr.ui5",
									"url": sap.ui.require.toUrl("rnd/srr/ui5")
								}
							}
						}
					}
